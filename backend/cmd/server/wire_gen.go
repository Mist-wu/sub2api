...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userImageGenerationRepository := repository.NewUserImageGenerationRepository(client)
	userImageLimitStore := repository.NewUserImageLimitStore(redisClient)
	...
	userImageService := service.NewUserImageService(userImageGenerationRepository, userImageLimitStore, apiKeyService, openAIGatewayService)
	imageHandler := handler.NewImageHandler(userImageService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, imageHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
