...
type UserEdges struct {
	...
	// ImageGenerations holds the value of the image_generations edge.
	ImageGenerations []*UserImageGeneration `json:"image_generations,omitempty"`
...
// ImageGenerationsOrErr returns the ImageGenerations value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) ImageGenerationsOrErr() ([]*UserImageGeneration, error) {
	if e.loadedTypes[7] {
		return e.ImageGenerations, nil
	}
	return nil, &NotLoadedError{edge: "image_generations"}
}
...
// QueryImageGenerations queries the "image_generations" edge of the User entity.
func (_m *User) QueryImageGenerations() *UserImageGenerationQuery {
	return NewUserClient(_m.config).QueryImageGenerations(_m)
}
