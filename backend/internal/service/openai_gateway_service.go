...
import (
	...
	"github.com/Mist-wu/sub2api/internal/pkg/apicompat"
	"github.com/Mist-wu/sub2api/internal/pkg/logger"
	"github.com/Mist-wu/sub2api/internal/pkg/openai"
	"github.com/Mist-wu/sub2api/internal/util/responseheaders"
	"github.com/Mist-wu/sub2api/internal/util/urlvalidator"
...
func isOpenAIModelUnsupportedForAccount(upstreamStatusCode int, upstreamMsg string, upstreamBody []byte) bool {
	if upstreamStatusCode != http.StatusBadRequest {
		return false
	}
...
func (s *OpenAIGatewayService) shouldFailoverOpenAIUpstreamResponse(statusCode int, upstreamMsg string, upstreamBody []byte) bool {
	...
	return isOpenAITransientProcessingError(statusCode, upstreamMsg, upstreamBody) ||
		isOpenAIModelUnsupportedForAccount(statusCode, upstreamMsg, upstreamBody)
}
