...
curl -sSL https://raw.githubusercontent.com/Mist-wu/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Mist-wu/sub2api/releases)
