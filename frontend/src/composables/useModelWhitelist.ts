...
const openaiPresetMappings = [
  ...
  { label: 'GPT Image 2', from: 'gpt-image-2', to: 'gpt-image-2', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' }
]
...
const geminiPresetMappings = [
  ...
  { label: '3 Pro Preview', from: 'gemini-3-pro-preview', to: 'gemini-3-pro-preview', color: 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400' },
  { label: '3.1 Pro Preview', from: 'gemini-3.1-pro-preview', to: 'gemini-3.1-pro-preview', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' }
]

// Antigravity 预设映射（支持通配符）
const antigravityPresetMappings = [
  { label: '3-Flash-Preview', from: 'gemini-3-flash-preview', to: 'gemini-3-flash', color: 'bg-lime-100 text-lime-700 hover:bg-lime-200 dark:bg-lime-900/30 dark:text-lime-400' },
  { label: '3-Pro-Preview', from: 'gemini-3-pro-preview', to: 'gemini-3-pro-high', color: 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400' },
  { label: '3.1-Pro-Preview', from: 'gemini-3.1-pro-preview', to: 'gemini-3.1-pro-high', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' }
]
