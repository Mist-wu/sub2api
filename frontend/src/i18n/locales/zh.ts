export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      gemini: {
        ...
        modelComment: '当前可用 Gemini 3.1 Pro：gemini-3.1-pro-preview',
        note: '这些环境变量将在当前终端会话中生效。如需永久配置，请将其添加到 ~/.bashrc、~/.zshrc 或相应的配置文件中。'
      },
      post: {
        title: 'POST 请求示例',
  ...
  image: {
    ...
    generate: '生成图片',
    generating: '生成中...',
    generateQueued: '绘图任务已开始',
    loadingTitle: '正在绘图',
    loadingHint: '生成会在后台继续，切换页面后回来仍可查看进度。',
    elapsed: '已耗时 {seconds}s',
    activeJobs: '任务 {active}/{max}',
    concurrentHint: '最多可同时生成 {max} 张图片。',
    concurrencyFull: '任务已满',
    concurrencyFullMessage: '当前最多同时生成 {max} 张图片，请等其中一张完成后再试。',
    currentResult: '当前结果',
    noResultTitle: '还没有图片',
