export default {
  ...
  image: {
    title: 'Image',
    description: 'Enter a prompt and generate a visually consistent image',
    promptLabel: 'Prompt',
    promptPlaceholder: 'Describe the subject, mood, scene, or style you want',
    promptHint: 'No size, ratio, or quality settings are needed.',
    promptRequired: 'Enter a prompt first',
    generate: 'Generate Image',
    generating: 'Generating...',
    generateQueued: 'Image task started',
    loadingTitle: 'Generating image',
    loadingHint: 'Generation continues in the background, even if you switch pages.',
    elapsed: '{seconds}s elapsed',
    activeJobs: 'Tasks {active}/{max}',
    concurrentHint: 'You can generate up to {max} images at the same time.',
    concurrencyFull: 'Limit reached',
    concurrencyFullMessage: 'You can generate up to {max} images at the same time. Wait for one to finish first.',
    currentResult: 'Current Result',
    noResultTitle: 'No image yet',
    noResultHint: 'Enter a prompt to generate your first image.',
    ...
    loadFileFailed: 'Failed to load image',
